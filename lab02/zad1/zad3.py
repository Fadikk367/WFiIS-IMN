...
if __name__ == "__main__":
  ...
  for i in np.arange(1, n):
    ...
    while True:
      m_11 = 1 - dt*a_11*(alpha - 2*Betha*U_1)
      m_12 = -dt*a_12*(alpha - 2*Betha*U_2)
      m_21 = -dt*a_21*(alpha - 2*Betha*U_1)
      m_22 = 1 - dt*a_22*(alpha - 2*Betha*U_2)

      dU_1 = (F_2(U_1, U_2, u[i-1])*m_12 - F_1(U_1, U_2, u[i-1])*m_22) / (m_11*m_22 - m_12*m_21)
      dU_2 = (F_2(U_1, U_2, u[i-1])*m_21 - F_1(U_1, U_2, u[i-1])*m_11) / (m_11*m_22 - m_12*m_21)
      ...
      if iter_count > 20 or is_within_tolerance(U_1, U_1_prev):
        break
